...
Some additional dependencies for future proofing:
```bash
sudo apt install libvulkan-dev libzstd1-dev
```
...
```bash
sudo apt install ninja-build generate-ninja libre2-dev libwebp-dev libwebpmux3 libwebpdemux2 libopus-dev ffmpeg libvpkx-dev libsnappy-dev libminizip-dev libjsoncpp-dev libprotobuf-dev libxml2-dev libxslt1-dev libpng-dev libjpeg-dev libharfbuzz-dev libtiff-dev libsqlite3-dev libpcre2-dev
```
